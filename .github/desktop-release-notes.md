...
The desktop app is unsigned on both macOS and Windows. On macOS, right-click → Open to bypass Gatekeeper. On Windows, click "More info" → "Run anyway" on the SmartScreen prompt.
...
### Full changelog and other ways to use OSW Studio

Full details for this version are in the [changelog](https://github.com/o-stahl/osw-studio/blob/main/CHANGELOG.md).
